...
// Structure:  u m rounded box modifier
public struct UMRoundedBoxModifier : ViewModifier {
	...
	public init (backgroundColor : Color? = nil,
		...
		// Initializes the UMRoundedBoxModifier.
...
public extension View {
	...
	func umRoundedBox (backgroundColor : Color? = nil,
		...
		self.modifier (UMRoundedBoxModifier (backgroundColor: backgroundColor,
